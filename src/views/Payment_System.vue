  ...
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作" width="100">
        <template slot-scope="scope">
          <el-button v-if="scope.row.flag == 1"  @click="handleClick (scope.row,1); dialogVisible = true "  type="text" size="small">缴费</el-button>
          <el-button v-if="scope.row.flag == 0"  @click="handleClick (scope.row,0); dialogVisible = true "  type="text" size="small">余额</el-button>
    ...
    <el-dialog title="提示" :visible.sync="dialogVisible" width="100%" top = "60vh"  @close="Close">
      <van-circle v-if="this.showmap == 1"  size="120px"  v-model="currentRate" :rate="this.percentage" :speed="150" layer-color="#ebedf0" :text="text" />
